...
public class Adapter_FighterNotesCreateSelect extends BaseAdapter {

    private List<Model_Icon> listOfFighterIcons;
    Context context;
    private LayoutInflater layoutInflater;

    public Adapter_FighterNotesCreateSelect(Activity activity, List<Model_Icon> listOfFighterIcons)
    {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null)
        {
            convertView = layoutInflater.inflate(R.layout.notes_create_select_row, null);
